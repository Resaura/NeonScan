...
public final class OptionsViewModel extends androidx.lifecycle.ViewModel {
    ...
    public final void updateExisting(@org.jetbrains.annotations.NotNull()
    com.neonscan.data.local.DocumentEntity doc, @org.jetbrains.annotations.NotNull()
    android.graphics.Bitmap bitmap, @org.jetbrains.annotations.NotNull()
    com.neonscan.data.model.DocumentFormat targetFormat, @org.jetbrains.annotations.NotNull()
    kotlin.jvm.functions.Function1<? super com.neonscan.data.local.DocumentEntity, kotlin.Unit> onSaved) {
    }
